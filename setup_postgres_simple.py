...
This version uses environment variables or prompts for password in a simpler way.

Usage:
1. Set environment variable: $env:PGPASSWORD="your_postgres_password"
2. Run: python setup_postgres_simple.py
"""
...
def create_database():
    ...
    if not postgres_password:
        print("PostgreSQL superuser (postgres) password not found in environment.")
        print("Please set it using: $env:PGPASSWORD='your_password'")
        print()
        print("Or enter password manually:")
    ...
    try:
        ...
        print()
        print("Next steps:")
        print("  1. Update Django settings.py to use PostgreSQL (already done)")
